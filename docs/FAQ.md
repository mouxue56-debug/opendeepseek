...
> 该问题为已知上游限制，DeepSeek 团队已在 V4 后续版本中优化。关注 [OpenDeepSeek Issues](https://github.com/mouxue56-debug/opendeepseek/issues) 获取进展。
...
> 还有其他问题？提交 [GitHub Issue](https://github.com/mouxue56-debug/opendeepseek/issues) 或查看 [完整文档目录](README.md)。
